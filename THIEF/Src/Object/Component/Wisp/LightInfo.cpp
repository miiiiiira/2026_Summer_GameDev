...
namespace LightTable
{
	const std::unordered_map<LIGHT_TYPE, LightData> Table =
	{
		...
		{LIGHT_TYPE::COLOR_11,{"Data/Model/Player/Light/Textures/Wisp/Wisp11.png",{0xbf,0x7f,0xff}}},
		{LIGHT_TYPE::COLOR_12,{"Data/Model/Player/Light/Textures/Wisp/Wisp12.png",{0xe0,0xe0,0xe0}}},
	};
}