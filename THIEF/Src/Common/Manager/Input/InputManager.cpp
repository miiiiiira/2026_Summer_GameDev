...
void InputManager::DefaultKey(void)
{
	...
	SetActionPadBtn(INPUT_INFO::ACTION::LIGHT, INPUT_INFO::JOYPAD_NO::PAD1, INPUT_INFO::PAD_BTN::RB);
	...
	SetActionPadTrigger(INPUT_INFO::ACTION::DASH, INPUT_INFO::JOYPAD_NO::PAD1, INPUT_INFO::PAD_TRIGGER::LT);
