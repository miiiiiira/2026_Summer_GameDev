...
void InputManager::Init(void)
{
	...
	SetActionPadBtn(INPUT_INFO::ACTION::TAB_LEFT, INPUT_INFO::JOYPAD_NO::PAD1, INPUT_INFO::PAD_BTN::LB);
	SetActionPadBtn(INPUT_INFO::ACTION::TAB_RIGHT, INPUT_INFO::JOYPAD_NO::PAD1, INPUT_INFO::PAD_BTN::RB);
